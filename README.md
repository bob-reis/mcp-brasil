...
[Quick Start](#quick-start) · [Origem e alterações](#origem-e-alterações) · [Fontes de dados](#fontes-de-dados) · [Casos de Uso](#casos-de-uso) · [Documentação](#documentação) · [Desenvolvimento](#desenvolvimento)
...
Este projeto foi baixado a partir de, e hoje deve ser lido como uma evolução inspirada por, [`jxnxts/mcp-brasil`](https://github.com/jxnxts/mcp-brasil). A base original serviu como ponto de partida conceitual para expor APIs públicas brasileiras via MCP/FastMCP, mas esta árvore foi bastante expandida e reorganizada.
...
|-----|-------------|------------|
| Portal da Transparência | Sim para ativar a feature | [Cadastro gratuito](https://portaldatransparencia.gov.br/api-de-dados/cadastrar-email) |
...
| [Catálogo de Features](docs/reference/features.md) | Catálogo de features e tools disponíveis |
