...
# BCB penalties ranking (tipo=2 → penalidades aplicadas a instituições financeiras)
BCB_PENALIDADES_URL = "https://www3.bcb.gov.br/rdrweb/rest/ext/ranking/arquivo?tipo=2"
