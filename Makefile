...
serve: ## Run MCP server over HTTP (default http://127.0.0.1:8889/mcp)
	uv run python -c "from mcp_brasil.server import mcp; mcp.run(transport='streamable-http', host='$(HOST)', port=$(PORT))"
